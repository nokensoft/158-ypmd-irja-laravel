...
@section('content')
    @php
        $_kdkMeta = 'Edisi ' . $kdk->nomor_edisi;
        if ($kdk->tanggal_terbit) $_kdkMeta .= ' &middot; ' . $kdk->tanggal_terbit->translatedFormat('d F Y');
    @endphp
    @include('partials.section-header', [
        'headerTitle' => $kdk->judul,
        'headerMeta' => $_kdkMeta,
        'headerBreadcrumb' => ' › <a href="' . route('kdk') . '" class="hover:text-white">KdK</a> › Edisi ' . e($kdk->nomor_edisi),
    ])
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="flex flex-col md:flex-row gap-8 mb-10">
                        <div class="w-48 md:w-56 shrink-0 aspect-[2/3] overflow-hidden bg-neutral-100">
